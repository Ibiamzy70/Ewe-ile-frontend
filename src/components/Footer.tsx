      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/create-profile" className="text-gray-600 hover:text-brand-600 transition-colors">
                  Create Profile
                </Link>
              </li>
              <li>
                <Link to="/job-alerts" className="text-gray-600 hover:text-brand-600 transition-colors">
                  Job Alerts
                </Link>
              </li>
              <li>
                <Link to="/career-resources" className="text-gray-600 hover:text-brand-600 transition-colors">
                  Career Resources
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/post-job" className="text-gray-600 hover:text-brand-600 transition-colors">
                  Post a Job
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/employer-resources" className="text-gray-600 hover:text-brand-600 transition-colors">
                  Resources
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} CareerSpark Pro. All rights reserved.
          </p>
